...
export class AdminApiPostApiClient {
     ...
     * @return Success
     */
    getPostById(id: string | null): Observable<PostDto> {
        let url_ = this.baseUrl + "/api/admin/Post/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
     ...
     * @return Success
     */
    deletePosts(body?: string[] | undefined): Observable<PostActivityLogDto[]> {
        let url_ = this.baseUrl + "/api/admin/Post";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processDeletePosts(response: HttpResponseBase): Observable<PostActivityLogDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getPostsPaging(keyword?: string | undefined, categoryId?: string | null | undefined, pageIndex?: number | null | undefined, pageSize?: number | null | undefined): Observable<PostInListDtoPagedResult> {
     ...
     * @return Success
     */
    getSeriesBelong(id: string | null): Observable<SeriesInListDto[]> {
     ...
     * @return Success
     */
    approvePost(id: string | null): Observable<void> {
     ...
     * @return Success
     */
    sendToApprove(id: string | null): Observable<void> {
        let url_ = this.baseUrl + "/api/admin/Post/send-approve/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    returnBack(id: string | null, body?: ReturnBackRequest | undefined): Observable<void> {
     ...
     * @return Success
     */
    getReason(id: string | null): Observable<void> {
    ...
    protected processGetReason(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getActivityLogs(id: string | null): Observable<PostActivityLogDto[]> {
...
export class AdminApiPostCategoryApiClient {
     ...
     * @return Success
     */
    updatePostCategory(id: string | null, body?: CreateUpdatePostCategoryRequest | undefined): Observable<void> {
     ...
     * @return Success
     */
    getPostCategoryById(id: string | null): Observable<PostCategoryDto> {
        let url_ = this.baseUrl + "/api/admin/PostCategory/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
     ...
     * @return Success
     */
    getPostCategoriesPaging(keyword?: string | undefined, pageIndex?: number | null | undefined, pageSize?: number | null | undefined): Observable<PostCategoryDtoPagedResult> {
...
export class AdminApiRoleApiClient {
     ...
     * @return Success
     */
    deleteRoles(roleIds?: string[] | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/admin/Role?";
        if (roleIds === null)
     ...
     * @return Success
     */
    savePermissions(body?: PermissionDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/admin/Role";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getAllRolesPaging(keyword?: string | undefined, pageIndex?: number | null | undefined, pageSize?: number | null | undefined): Observable<RoleDtoPagedResult> {
    ...
    protected processGetAllRolesPaging(response: HttpResponseBase): Observable<RoleDtoPagedResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getAllRolePermissions(id: string): Observable<PermissionDto> {
        let url_ = this.baseUrl + "/api/admin/Role/{id}/permisisons";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
...
export class AdminApiSeriesApiClient {
     ...
     * @return Success
     */
    getAllSeries(): Observable<SeriesDto[]> {
        let url_ = this.baseUrl + "/api/admin/Series";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAllSeries(response: HttpResponseBase): Observable<SeriesDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    updateSeries(id: string | null, body?: CreateUpdateSeriesRequest | undefined): Observable<void> {
     ...
     * @return Success
     */
    getSeriesById(id: string | null): Observable<SeriesDto> {
        let url_ = this.baseUrl + "/api/admin/Series/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
     ...
     * @return Success
     */
    getSeriesPaging(keyword?: string | undefined, pageIndex?: number | null | undefined, pageSize?: number | null | undefined): Observable<SeriesInListDtoPagedResult> {
     ...
     * @return Success
     */
    getPostsInSeries(id: string | null): Observable<PostInListDto[]> {
...
export class AdminApiUsersApiClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    updateUser(id: string | null, body?: UpdateUserRequest | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/admin/Users/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
     ...
     * @return Success
     */
    getAllUserPaging(keyword?: string | undefined, pageIndex?: number | null | undefined, pageSize?: number | null | undefined): Observable<UserDtoPagedResult> {
     ...
     * @return Success
     */
    setPassword(id: string | null, body?: SetPasswordRequest | undefined): Observable<void> {
     ...
     * @return Success
     */
    changeEmail(id: string | null, body?: ChangeEmailRequest | undefined): Observable<void> {
