...
import { AdminApiRoleApiClient, AdminApiUsersApiClient, RoleDto, UserDto } from 'src/app/api/admin-api.service.generated';
...
export class RoleAssignComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private userApiClient: AdminApiUsersApiClient,
